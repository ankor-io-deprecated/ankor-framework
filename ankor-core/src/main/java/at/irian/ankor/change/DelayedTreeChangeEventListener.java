 ...
 */
public abstract class DelayedTreeChangeEventListener extends ChangeEvent.TreeListener
    ...
    public DelayedTreeChangeEventListener(Ref watchedProperty, long delayMilliseconds) {
