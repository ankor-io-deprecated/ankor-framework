 ...
 * the model (e.g. for two-binding) he must not directly change the model because he has no exclusive
...
public class ChangeRequestEvent extends ModelEvent {
    ...
    public ChangeRequestEvent(Ref propertyToChange, Object newValue) {
