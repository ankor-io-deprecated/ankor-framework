define([
    ...
    var TaskList = function(modelRef) {
        ...
        var modelVal = modelRef.getValue();

        var $app = $("#app");
        $("body").html(template.render({}));

        $('#todo-count > strong').ankorBindInnerHTML(modelRef.append("itemsLeft"));
        $('#todo-count > span').ankorBindInnerHTML(modelRef.append("itemsLeftText"));
        $('#clear-completed').ankorBindInnerHTML(modelRef.append("itemsCompleteText"));
